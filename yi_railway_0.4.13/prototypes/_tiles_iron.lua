data:extend(
{
	...
	{
		type = "recipe",
		name = "yir_iron_tile_recipe",
		energy_required = 2,
		enabled = true,		
		ingredients = {{"iron-plate", 1},},
		result= "yir_iron_tile",
		order = "metal-0",
		result_count = 1
	},
	]]
	{
		type = "item",
		name = "yir_iron_tile",
		icon = "__yi_railway__/graphics/entity/path_tiles/iron_plate_tile_icon.png",
	...
	
	{
		...
		minable = {hardness = 0.2, mining_time = 0.5, result = "yir_iron_tile"},
		...
		variants =
		{
			...
			{
				{
					picture = "__yi_railway__/graphics/entity/path_tiles/iron_plate_tile.png",
					count = 1,
					size = 1
				},
			},
