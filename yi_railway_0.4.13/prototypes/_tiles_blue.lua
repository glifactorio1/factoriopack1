data:extend(
{
	...
	{
		type = "recipe",
		name = "yir_blue_tile_recipe",
		energy_required = 2,
		enabled = true,		
		ingredients = {{"stone-brick", 2},{"yir_color_blue", 1},},
		result= "yir_blue_tile",
	...
	]]
	{
		type = "item",
		name = "yir_blue_tile",
		icon = "__yi_railway__/graphics/entity/path_tiles/blue_plate_tile_icon.png",
	...
	
	{
		...
		minable = {hardness = 0.2, mining_time = 0.5, result = "yir_blue_tile"},
		...
		variants =
		{
			...
			{
				{
					picture = "__yi_railway__/graphics/entity/path_tiles/blue_plate_tile.png",
					count = 1,
					size = 1
				},
			},
