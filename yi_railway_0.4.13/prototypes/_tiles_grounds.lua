data:extend(
{
	...
	
	{
		...
		icon = "__yi_railway__/graphics/entity/path_tiles/ground_1.png",
	...
	
	{
		...
		icon = "__yi_railway__/graphics/entity/path_tiles/plates_2.png",
		flags = {"goes-to-main-inventory"},
		subgroup = "yir_floor_line2",		
		order = "ground-2",
		stack_size = 500,
	...
	
	{
		...
		icon = "__yi_railway__/graphics/entity/path_tiles/muster-1.png",
		flags = {"goes-to-main-inventory"},
		subgroup = "yir_floor_line2",		
		order = "ground-3",
		stack_size = 500,
