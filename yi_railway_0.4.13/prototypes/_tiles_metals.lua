data:extend(
{
	...
	{ type = "item", name = "yir_metal1_tile", icon = "__yi_railway__/graphics/entity/path_tiles/metal_1.png", flags = {"goes-to-main-inventory"}, subgroup = "yir_floor_line3", order = "metal-1", stack_size = 500, place_as_tile = { result = "yir_metal1_tile", condition_size = 2, condition = { "water-tile" }} },	
	{
		type = "tile",
		...
		walking_sound =	{
			{	filename = "__base__/sound/walking/concrete-01.ogg", volume = 1.2},
	...
	{ type = "item", name = "yir_metal2_tile", icon = "__yi_railway__/graphics/entity/path_tiles/metal_2.png", flags = {"goes-to-main-inventory"}, subgroup = "yir_floor_line3", order = "metal-2", stack_size = 500, place_as_tile = { result = "yir_metal2_tile", condition_size = 2, condition = { "water-tile" }} },	
	{
		type = "tile",
		...
		variants =
		{
			main ={{picture = "__yi_railway__/graphics/entity/path_tiles/metal_2.png",count = 1,size = 1},},
	...
	{ type = "item", name = "yir_metal3_tile", icon = "__yi_railway__/graphics/entity/path_tiles/metal_3.png", flags = {"goes-to-main-inventory"}, subgroup = "yir_floor_line3", order = "metal-3", stack_size = 500, place_as_tile = { result = "yir_metal3_tile", condition_size = 2, condition = { "water-tile" }} },	
	{
		type = "tile",
	...
	{ type = "item", name = "yir_metal4_tile", icon = "__yi_railway__/graphics/entity/path_tiles/metal_4.png", flags = {"goes-to-main-inventory"}, subgroup = "yir_floor_line3", order = "metal-4", stack_size = 500, place_as_tile = { result = "yir_metal4_tile", condition_size = 2, condition = { "water-tile" }} },	
	{
		type = "tile",
	...
	{ type = "item", name = "yir_metal5_tile", icon = "__yi_railway__/graphics/entity/path_tiles/vent_round.png", flags = {"goes-to-main-inventory"}, subgroup = "yir_floor_line3", order = "vent-3", stack_size = 500, place_as_tile = { result = "yir_metal5_tile", condition_size = 2, condition = { "water-tile" }} },	
	{
		type = "tile",
