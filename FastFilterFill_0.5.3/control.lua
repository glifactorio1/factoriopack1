...
function getRows(player)
    if player.opened.name == "cargo-wagon" then
        return 3
	elseif player.opened.name == "cargo-wagon-2" then
        return 4.5
	elseif player.opened.name == "cargo-wagon-3" then
        return 6	
    else
        return nil
    end
...
function canFilter(obj)
    if obj.name == "cargo-wagon" or "cargo-wagon-2" or "cargo-wagon-3" then
      return true
--	elseif obj.type == "cargo-wagon-2" then
 --     return true
--	elseif obj.type == "cargo-wagon-3" then
 --     return true
   else
      return false
   end
